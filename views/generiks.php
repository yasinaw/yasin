  ...
  <header class="navbar navbar-inverse navbar-fixed-top" role="banner">
        ...
        <div class="section">
	    	<div class="container">
				...
				<div class="col-sm-12">
						<h2>Obat Bebas</h2>
						<h3>Daftar obat-obatan generik</h3>
						<p>Ini merupakan tanda obat yang paling "aman" . 
Obat bebas, yaitu obat yang bisa dibeli bebas di apotek, bahkan di warung, tanpa resep dokter, ditandai dengan lingkaran hijau bergaris tepi hitam. Obat bebas ini digunakan untuk mengobati gejala penyakit yang ringan. 
						</p>
					
					</div>
				</div>
				<form action="<?php echo base_url()."index.php/Welcome/search_keywordg"; ?>" method = "post">
