    ...
    <body>
     ...
     <header class="navbar navbar-inverse navbar-fixed-top" role="banner">
        ...
        <table>
            <tr>
                <td>Barcode</td>
                <td><input type="text" name="barcode" value="<?php echo $barcode ?>" readonly/></td>
            </tr>
            <tr>
                <td>Nama Obat</td>
                <td><input type="text" name="namaObat" value="<?php echo $namaObat ?>" /></td>
            </tr>
            <tr>
                <td>Kegunaan</td>
                <td><input type="text" name="kegunaan" value="<?php echo $kegunaan ?>" /></td>
            </tr>
            <tr>
                <td>Stok</td>
            ...
            <tr>
                <td>Jenis Code</td>
                <td><input type="text" name="jeniscode" value="<?php echo $jeniscode ?>" /></td>
            </tr>
            <tr>
                <td></td>
